        ...
        <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
            ...
            <div class="relative flex items-center gap-3">
                ...
                <div id="logoutTampil" class="absolute right-0 top-14 z-50 hidden w-44 rounded-lg border border-gray-200 bg-white p-2 shadow-lg">
                    <a href="/profile" class="inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        ...
                        <button id="logoutButtonOpen" type="submit" class="inline-flex w-full items-center rounded-md px-3 py-2 text-left text-sm text-red-500 hover:cursor-pointer hover:bg-red-100/70">
                            <span class="mr-2 inline-flex h-4 w-4 items-center justify-center">
